...
@include('components.breadcrumb',['title' => 'blog page'])
            ...
            <div class="col-lg-8">
                ...
                <article class="cropium-blog-item">
                    ...
                    <div class="blog-content">
                        <div class="blog-meta">
                            <ul>
                                <li><a href="#"><i class="fa fa-user-o"></i>{{ $singlePost->author_name }}</a></li>
                                <li><a href="#"><i class="fa fa-bookmark-o"></i>{{ $singlePost->category_name }}</a>
                                </li>
                            </ul>
                        </div>
                        <h3 class="title"><a
                                href="{{ route('posts.show', ['id' => $singlePost->id]) }}">{{ $singlePost->title }}</a>
                        </h3>
